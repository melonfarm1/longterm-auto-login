...
class Popup extends React.Component {
  ...
  open_longterm(data){
    chrome.storage.sync.set({"longterm":JSON.stringify(data)}, function () {
      document.getElementById("newtab").click()
      //chrome.storage.sync.get("longterm", function (value) { console.log("read value: ", value.test); } );
    });
    ...
    chrome.browserAction.onClicked.addListener(function(tab) {
      chrome.windows.create({
        // Just use the full URL if you need to open an external page
        url: chrome.runtime.getURL("https://longtermcare.or.kr/npbs/auth/login/loginForm.web?menuId=npe0000002160&rtnUrl=&zoomSize=")
      });
    });*/
  }
